// https://api.themoviedb.org/3/genre/movie/list?api_key=913e10c847c55fbb2045a16908b5870b&language=en-US
...
export const useGenresLocalStorage = () => {
    ...
    const getGenres =  () => {
        ...
        const resp = moviesApi.get<Genres>(`genre/movie/list?api_key=${api_key}&language=en-US`);
